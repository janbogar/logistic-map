...
def do_the_thing(worker,filename_base,generation_steps,N_points,y_min,y_max,x_min,x_max,seed):
    ...
    for generation_step in generation_steps:
        ...
        with open(f"{filename_base}_worker={worker}_generations={total_generations}.txt","w") as f:
...
for i in range(workers):
    processes.append(Process(target=do_the_thing,args=(i,"data/logistic_map",generation_steps,N_points,y_min,y_max,x_min,x_max,i*42)))
